    ...
    <div name="about" className="w-full min-h-screen bg-primary text-white py-16 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="space-y-6 text-base sm:text-lg lg:text-xl">
          ...
          >
            I am Amolika Kale, a motivated and skilled MERN Stack Developer with
            a strong foundation in Full Stack development. Leveraging a
            comprehensive educational background in Computer Science (BSc) , along with certifications in Web Full Stack Development, I bring a
            versatile skill set to the table. My technical expertise spans modern web
            technologies including MongoDB, Express.js, React.js, Node.js, HTML5, CSS3,
